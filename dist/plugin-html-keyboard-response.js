var jsPsychHtmlKeyboardResponse = (function (jspsych) {
  ...
  const info = {
    ...
    parameters: {
      ...
      // ¡NUEVO PARÁMETRO AQUÍ!
      /**
       * Specifies which property of the KeyboardEvent object to use for validation
       * and for the `response` property in the trial data. Can be 'key' (default)
       * or 'code'. Use 'code' for differentiating between left/right Shift, Alt, etc.
       */
      key_property_for_validation: {
        type: jspsych.ParameterType.STRING,
        default: "key", // Por defecto, usa 'key' para compatibilidad
      },
    },
    data: {
    ...
    trial(display_element, trial) {
      ...
      if (trial.choices != "NO_KEYS") {
        var keyboardListener = this.jsPsych.pluginAPI.getKeyboardResponse({
          ...
          key_property_for_validation: trial.key_property_for_validation,
        });
      }
